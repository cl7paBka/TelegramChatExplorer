...
class TelegramChatAnalyzer:
    ...
    def __init__(self, chat_data, excluded_words=None, top_n_words=None, language='en'):
    ...
    def print_chat_type(self):
        ...
        if config.print_chat_type is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_total_users(self):
        ...
        if config.print_total_users is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_total_messages(self):
        ...
        if config.print_total_messages is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_messages_by_user(self):
        ...
        if config.print_messages_by_user is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_total_characters(self):
        ...
        if config.print_total_characters is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_characters_by_user(self):
        ...
        if config.print_characters_by_user is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_total_words(self):
        ...
        if config.print_total_words is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_words_by_user(self):
        ...
        if config.print_words_by_user is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
            ...
            print("\nWords by user:")
        for user, stats in self.user_stats.items():
            print(f"  {user}: {stats['total_words']} слов" if self.language == 'ru' else f"  {user}: {stats['total_words']} words")

    def print_average_message_length_by_user(self):
        """Выводит среднее количество символов на сообщение для каждого участника."""
        if config.print_average_message_length_by_user is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
        ...
        for user, stats in self.user_stats.items():
            if stats['messages'] > 0:
                ...
                print(f"  {user}: {round(avg_length)} символов" if self.language == 'ru' else f"  {user}: {round(avg_length)} characters")

    def print_total_unique_words_count(self):
        """Выводит общее количество уникальных слов."""
        if config.print_total_unique_words_count is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_unique_words(self):
        ...
        if config.print_unique_words is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_average_words_per_message_by_user(self):
        ...
        if config.print_average_words_per_message_by_user is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_total_media_messages(self):
        ...
        if config.print_total_media_messages is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_media_messages_by_user(self):
        ...
        if config.print_media_messages_by_user is None:
            return  # Пользователь отключил функцию
        for user, stats in self.user_stats.items():
    ...
    def print_voice_messages_duration(self):
        ...
        if config.print_voice_messages_duration is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
    ...
    def print_video_messages_duration(self):
        ...
        if config.print_video_messages_duration is None:
            return  # Пользователь отключил функцию
        if self.language == 'ru':
